          ...
          <>
            ...
            <PaginatedMetricTable
              ...
              rows={operating.advisors.map((row) => [
                ...
                row.call_coverage_rate_7d != null ? formatPercent(row.call_coverage_rate_7d) : '—',
                row.call_coverage_rate_15d != null ? formatPercent(row.call_coverage_rate_15d) : '—',
                row.call_coverage_rate_30d != null ? formatPercent(row.call_coverage_rate_30d) : '—',
